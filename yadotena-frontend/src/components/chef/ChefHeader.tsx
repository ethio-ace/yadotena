...
import { UtensilsCrossed, Volume2, VolumeX, Layers, ListFilter, History, Wifi, WifiOff, Clock } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-40 bg-zinc-950 text-zinc-100 border-b border-zinc-800 shadow-xl px-4 py-3">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-start">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-500/20 text-zinc-950 shrink-0">
              <UtensilsCrossed className="h-6 w-6 font-black" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h1 className="font-black text-lg tracking-tight text-white uppercase">
                  Yadotena <span className="text-amber-500">Kitchen KDS</span>
                </h1>
              </div>
              <p className="text-[11px] font-medium text-zinc-400">
                Production Station • {chefName}
              </p>
            </div>
          </div>
        ...
        {/* Right View Switcher & Sound Toggle */}
